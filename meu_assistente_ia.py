# Assistente de IA - Assistente de Programação Python, em Python
...
# Importa do streamlit o conversor de imagem
import streamlit as st
from PIL import Image

# Configura a página do Streamlit com título, ícone, layout e estado inicial da sidebar
img = Image.open("IMG-20251028-WA0053[1].JPG")
st.set_page_config(
    page_title="Assistente de IA para Python",
    page_icon=img,
    layout="wide",
...
CUSTOM_PROMPT = """
Você é o "Assistente de IA para Python", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.title("Meu Assistente para Python")
    ...
    st.markdown("🔗 [Meu Linkedin](www.linkedin.com/in/marcos-almeida-couto-555568112)")

# Título principal do app
st.title("Assistente de IA para Python")
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>Assistente de IA para Python - Parte integrante do meu portfólio de projetos</p>
    </div>
    """,
